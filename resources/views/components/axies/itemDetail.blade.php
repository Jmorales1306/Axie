    ...
    <div>
        ...
        <div class="flex">
            ...
            <div class="flex gap-3">
                <button  class="bg-secundary-grey ps-[9px] pt-[11px] pb-[9px] w-9 h-9 rounded-full">
                ...
                <button  class="bg-secundary-grey px-[10px] py-4 w-9 h-9 rounded-full">
...
Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptates blanditiis repudiandae quam ratione. Distinctio atque perferendis esse facere laudantium earum ad vero voluptatum nisi blanditiis tempore, eius sit eveniet. Suscipit.
        </p>
